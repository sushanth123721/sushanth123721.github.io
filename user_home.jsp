...
<div id="container">
		...
		<div id="content">
        	<h2>&nbsp; </h2>
       	  <h3>&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; &nbsp; Welcome : <%=nme%> &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;  &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp;   &nbsp; &nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;<a href="index.html">Logout</a></h3>
  ...
  int am = 0;
	...
	try
		...
		st = con.prepareStatement("select * from user_reg where sno='"+sn+"'");
		rs = st.executeQuery();
		while(rs.next())
       	{
  ...
  String  cf = null,cf1 = null;
	...
	try
		...
		st2 = con.prepareStatement("select * from friends where sender='"+nme+"'");
  ...
  int gsn=0;
	...
	try
		...
		st3 = con3.prepareStatement("select * from chat where getter_id='"+l2+"'");
  ...
  String  cm1 = null;
	...
	try
		...
		st1 = con.prepareStatement("select * from user_reg");
	   ...
	   catch(Exception e21)
	   {
	    ...
	    %>
            ...
            <div id="footer">
			 <p align="center"> <a target="_blank" href="http://www.chennaisunday.com">WWW.CHENNAISUNDAY.COM </a></p>
		  </div>
      </div>
   </div>
</body>
