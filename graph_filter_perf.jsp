...
JDBCCategoryDataset dataset=new JDBCCategoryDataset("jdbc:mysql://localhost:3306/message_filter","com.mysql.jdbc.Driver","root","admin");
...
ChartUtilities.saveChartAsJPEG(new File("F:/apache-tomcat-6.0.18/webapps/A-System-to-Filter-Unwanted-Messages-from-OSN-User-Walls/Graph/filter.jpg"), chart, 600, 400);
